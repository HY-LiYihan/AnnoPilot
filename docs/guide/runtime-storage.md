...
- Export manifest 记录 source run ids、annotation import history、schema version、artifact hashes、event actor/type audit summary 和 timestamp。
