...
- 支持导出 task JSONL、Prodigy `ner_manual` / `spans_manual` JSONL、Goldsmith/Rosetta-style review queue 与 human choices JSONL、manifest JSON、events JSONL 和 Character RAG run provenance JSON。
