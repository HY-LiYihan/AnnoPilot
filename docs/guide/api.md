...
- `sample-presets` 返回后端内置的轻量样例索引；当前包含通用、新闻/政策、学术/方法、平台复核、客服反馈、合规/法律、社交舆情、财报/投资者沟通、医疗/科学传播、AI 教育、气候/能源、职场/劳动关系、产品安全/公众意见、危机回应/公共警示，以及 Goldsmith/Rosetta 校准场景十五类 bilingual Engagement 样例。每个 preset 还返回 `auto_accept_on_load` 和 `complete_sentences_on_load`，供 UI 按场景选择快速标注或保留 review 候选。
