...
- Prodigy export 保持 `ner_manual` / `spans_manual` compatible fields，并提供 bundle ZIP 把 Prodigy JSONL、label config、tag schema、Goldsmith review queue、label statistics 和 manifest 收拢成一个交付包。
