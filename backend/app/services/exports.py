                        ...
                        json.dumps(
                            {
                                ...
                                "answer": None,
                                "explanation": candidate.get("explanation") or f"Immutable sentence candidate from annotation run {candidate['run_id']}.",
                                ...
                                "meta": {
                                    ...
                                    "verifier_issues": candidate.get("verifier_issues", []),
                                    "prompt_sha256": candidate.get("prompt_sha256"),
                                    "candidate_consistency": candidate.get("consistency", {}),
